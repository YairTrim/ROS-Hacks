...
alias cob='colcon build --symlink-install --cmake-args -Wno-dev'
alias cobd='colcon build --symlink-install --cmake-args -Wno-dev -DCMAKE_BUILD_TYPE=Debug'
alias cobr='colcon build --symlink-install --cmake-args -Wno-dev -DCMAKE_BUILD_TYPE=Release'
alias cobp='colcon build --symlink-install --cmake-args -Wno-dev --packages-select'
alias cobput='colcon build --symlink-install --cmake-args -Wno-dev --packages-up-to'
alias cobpv='colcon build --symlink-install --cmake-args -Wno-dev --event-handlers console_cohesion+ --packages-select'
